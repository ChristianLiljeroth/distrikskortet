Website for finding all Danish addresses within a specified area. The project is a few years old by now, and I would preferably move a lot of the functionality to server-side, if I did the project today.
